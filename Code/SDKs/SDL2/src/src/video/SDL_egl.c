...
#define DEFAULT_OGL_ES3 "libGLESv3.so"
#define DEFAULT_OGL_ES2 "libGLESv2.so"
#define DEFAULT_OGL_ES_PVR "libGLES_CM.so"
#define DEFAULT_OGL_ES "libGLESv1_CM.so"
#define DEFAULT_OGL DEFAULT_OGL_ES3
...
// EGL_KHR_create_context from NVidia "gl-gles-setup-samples-20131022"
...
{
    EGLint default_context_attrs[] = {
        EGL_CONTEXT_CLIENT_VERSION,
        1,
        EGL_NONE
    };
    
    EGLint gl4_context_attrs[] = {
        EGL_CONTEXT_MAJOR_VERSION_KHR, 4,
        EGL_CONTEXT_OPENGL_PROFILE_MASK_KHR, EGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT_KHR,
        EGL_NONE
    };

    EGLint* context_attrib_list = default_context_attrs;
    if ((_this->gl_config.profile_mask & SDL_GL_CONTEXT_PROFILE_CORE) != 0
            && _this->gl_config.major_version == 4) {
            context_attrib_list = gl4_context_attrs;
    }
