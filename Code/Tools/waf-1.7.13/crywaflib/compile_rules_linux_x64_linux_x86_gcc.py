...
@conf
def check_linux_x64_linux_x86_gcc_installed(conf):
	"""
	Check compiler is actually installed on executin machine
	"""
	return  True	
	
@conf
def load_linux_x64_linux_x86_gcc_common_settings(conf):
	"""
	Setup all compiler and linker settings shared over all linux_x64_linux_x86_gcc configurations
	"""
	v = conf.env
