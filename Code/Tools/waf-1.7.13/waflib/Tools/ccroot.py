...
def use_rec(self, name, **kw):
	...
	if not stlib:
		# Only static libraries are considered to have their dependencies available
		# All other outputs could/should be hiding their dependencies, so they should not be considered
		return
